...
module error_handler
   ! Version of the error_handler module used by the errcodes program
   ...
   type :: err_msg_line
      ...
      integer(our_int) :: iobs = 0, ivar = 0, iiter=0, icycle=0, &
           igrp=0, itrm=0, ifac=0, ilev=0, imod=0
...
!         INCLUDE "icodes_3.h" 
   ...
   subroutine append_msg_line(line, err, &
        ...
        iobs, ivar, iiter, icycle, igrp, itrm, ifac, ilev, imod )
   ...
   subroutine err_get_codes(err, msg_codes, nlines)
      ...
      !
      !    msg_codes(n,p) should have at least 13 columns:
      !
