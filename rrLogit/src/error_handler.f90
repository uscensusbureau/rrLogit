...
module error_handler
   ...
   type :: err_msg_line
      ...
      integer(our_int) :: iobs = 0
      integer(our_int) :: ivar = 0, iiter=0, icycle=0, &
...
contains
   ...
   subroutine append_msg_line(line, err, &
      ...
      integer(our_int), optional, intent(in) :: iobs, &
           ivar, iiter, icycle, igrp, itrm, ifac, ilev, imod, iest, &
           ipred, iimp, icell
