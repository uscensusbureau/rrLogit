...
! and indexing. Elements of integer arrays are still kind=our_int
!#####################################################################
module dynalloc
...
contains
   ...
   integer(our_int) function int1_alloc(intArray, dim1, err, &
      ...
      integer(kind=long_int), intent(in) :: dim1
      type(error_type), intent(inout) :: err
      ! declare optional arguments
      integer(kind=long_int), intent(in), optional :: lbound1
      ! declare local variables and parameters
      integer(kind=long_int) :: lb1
...
810   call err_handle(err, 1, &
   ...
   integer(our_int) function int2_alloc(intArray, dim1, dim2, err, &
      ...
      ! declare required arguments
      integer(kind=our_int), pointer :: intArray(:,:)
      integer(kind=long_int), intent(in) :: dim1, dim2
      type(error_type), intent(inout) :: err
      ! declare optional arguments
      integer(kind=long_int), intent(in), optional :: lbound1, lbound2
      ! declare local variables and parameters
      integer(kind=long_int) ::lb1, lb2
      integer(kind=our_int) :: status
...
810   call err_handle(err, 1, &
   ...
   integer(our_int) function int3_alloc(intArray, dim1, dim2, dim3, &
      ...
      ! declare required arguments
      integer(kind=our_int), pointer :: intArray(:,:,:)
      integer(kind=long_int), intent(in) :: dim1, dim2, dim3
      type(error_type), intent(inout) :: err
      ! declare optional arguments
      integer(kind=long_int), intent(in), optional :: lbound1, lbound2, &
           lbound3
      ! declare local variables and parameters
      integer(kind=long_int) :: lb1, lb2, lb3
      integer(kind=our_int) :: status
...
810   call err_handle(err, 1, &
   ...
   integer(our_int) function dbl4_alloc(dblArray, dim1, dim2, dim3, &
      ...
      ! declare required arguments
      real(kind=our_dble), pointer :: dblArray(:,:,:,:)
      integer(kind=long_int), intent(in) :: dim1, dim2, dim3, dim4
      type(error_type), intent(inout) :: err
      ! declare optional arguments
      integer(kind=long_int), intent(in), optional :: lbound1, lbound2, &
           lbound3, lbound4
      ! declare local variables and parameters
      integer(kind=long_int) :: lb1, lb2, lb3, lb4
      integer(kind=our_int) :: status
...
810   call err_handle(err, 1, &
   ...
   integer(our_int) function log3_alloc(logArray, dim1, dim2, dim3, &
      ...
      type(error_type), intent(inout) :: err
      ! declare optional arguments
      integer(kind=long_int), intent(in), optional :: lbound1, lbound2, lbound3
      ! declare local variables and parameters
      integer(kind=long_int) :: lb1, lb2, lb3
      integer(kind=our_int) :: status
